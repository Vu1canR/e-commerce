        ...
        <div class="app-content">
            ...
            <div class="products-area-wrapper tableView">
                <div class="products-header">
                    ...
                    <div class="product-cell status-cell">Sub-category
                        <button class="sort-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                ...
                <div class="products-row" v-for="(product,index) in products" :key="index">
                    ...
                    <div class="product-cell category">
                        <span class="cell-label">Category:</span>{{product.category.name}}</div>
                    <div class="product-cell status-cell">
                        <span class="cell-label">Status:</span>
                        <span class="status active">Active</span>
                    </div>
                    <div class="product-cell sales"><span class="cell-label">Sales:</span>{{product.quantity}}</div>
